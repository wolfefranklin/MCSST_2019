...
Run as:
    Stand alone script with raw input by user of all required inputs.
Notes:
...
workDir = raw_input("Full path to working folder: ")
inDEM = raw_input("DEM (including full path): ")
geolExist = raw_input("Use geology layer? (YES/NO): ")
if geolExist.lower() not in ["yes", "no"]:
    sys.exit("!!! Enter YES or NO for 'Use geology layer?' !!!")
if geolExist.lower() == "yes":
    inGeol = raw_input("Geology layer (including full path): ")
    ageMinField = raw_input("Min Age field (within Geology layer): ")
    ageMaxField = raw_input("Max Age field (within Geology layer): ")
    geolField = raw_input("Unit Name field (within Geology layer): ")
inProfile = raw_input("Profile lines layer (including full path): ")
profIDField = raw_input("Profile ID field (within Profile line layer): ")
pointDist = int(raw_input("Point distance (integer): "))
...
if geolExist.lower() == "yes":  # geology used
...
if geolExist.lower() == "no":  # no geology exists
